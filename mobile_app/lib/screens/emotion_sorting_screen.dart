...
/// feeling category boxes (happy, sad, angry, etc.).
...
class _EmotionSortingScreenState extends State<EmotionSortingScreen>
  ...
  // Categories with their representative emoji and color
  static const List<Map<String, dynamic>> _categories = [
    {'name': 'Happy', 'emoji': '😊', 'color': Color(0xFFFBBF24)},
    {'name': 'Sad', 'emoji': '😢', 'color': Color(0xFF60A5FA)},
    {'name': 'Angry', 'emoji': '😡', 'color': Color(0xFFF87171)},
    {'name': 'Scared', 'emoji': '😨', 'color': Color(0xFFA78BFA)},
  ];

  // All emoji items to sort, each belongs to a category
  ...
  void _setupRound() {
    ...
    if (cats.length < 2) {
      ...
      final replacement = _allItems.firstWhere((e) => e['category'] == otherCat['name']);
          ...
          child: SafeArea(
            child: Stack(
              ...
              Positioned(
                ...
                child: Center(
                  child: Container(
                    padding: const EdgeInsets.symmetric(vertical: 14, horizontal: 31),
                    decoration: BoxDecoration(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text('📋 Sort: ', style: _cute(sz: 29, fw: FontWeight.w900, c: Colors.black87)),
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text('All Sorted!',
                            style: _cute(sz: 32, fw: FontWeight.w900, c: const Color(0xFF22C55E))),
                      ],
                    ),
                  ),
                ),
    ...
    return Padding(
      ...
      child: Row(
        children: _categories.map((cat) {
          ...
          final totalForCat = _currentItems.where((e) => e['category'] == name).length;
          ...
          return Expanded(
            child: Padding(
              ...
              child: DragTarget<int>(
                ...
                onAcceptWithDetails: (details) => _onItemDropped(details.data, name),
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(name,
                                ...
                                style: _cute(sz: 55, fw: FontWeight.w900, c: Colors.black)),
                            const SizedBox(height: 6),
                            // Show sorted emojis
                            if (sortedCount > 0)
                              SizedBox(
                                width: 140, // constrain wrap width inside FittedBox
                                child: Wrap(
                                  ...
                                  children: _currentItems
                                      .asMap()
                                      .entries
                                      .where((e) => _itemSorted[e.key] && e.value['category'] == name)
                            ...
                            if (sortedCount > 0)
                              Padding(
                                ...
                                child: Text('$sortedCount/$totalForCat',
                                    style: _cute(sz: 18, c: color.withValues(alpha: 0.7))),
                              ),
                            if (isHovered)
                              Padding(
