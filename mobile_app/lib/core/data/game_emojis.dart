...
class GameEmojis {
  ...
  static const List<GameEmoji> all = [
    ...
    GameEmoji(
        ...
        color: Color(0xFF74B9FF)),
    GameEmoji(
        emoji: '🤗', name: 'Hug', category: 'needs', color: Color(0xFFFF7EB3)),
    GameEmoji(
        emoji: '💧',
        name: 'Water',
        category: 'needs',
    ...
    GameEmoji(
        emoji: '🍎', name: 'Food', category: 'needs', color: Color(0xFFFF6B6B)),
    GameEmoji(
        emoji: '🚽',
        name: 'Toilet',
        category: 'needs',
    ...
    GameEmoji(
        emoji: '🎧', name: 'Hear', category: 'needs', color: Color(0xFFA29BFE)),
    GameEmoji(
        emoji: '🧸',
        name: 'Comfort',
        category: 'needs',
  ...
  static List<GameEmoji> shuffledFeeingsFirst(Random rng) {
    ...
    final rest = all.where((e) => e.category != 'feelings').toList()
      ..shuffle(rng);
